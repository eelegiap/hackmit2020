...
.padding(0.2);
    ...
    .text("Lack of High-Speed Household Internet Access");
map.append('text')
    .attr('x', 450)
    .attr('y', 8)
    .attr('font-size', 15)  
    ...
    .attr('fill', '#8c96c6') 
    .attr('class', 'title')
    .text("Estimated percent of students who lack any high-speed household internet access");
...
d3.select('#source')
.text('American Community Survey, IPUMS USA, University of Minnesota, www.ipums.org.');
...
if (Modernizr.svg) {
    ...
    queue()
        ...
        .defer(d3.json, "data/config-high-speed-internet.json")
        .defer(d3.csv, "data/no_hispeed.csv")
        .await(ready);
